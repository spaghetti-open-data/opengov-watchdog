Raccogliamo il flusso temporale di domande fatte come comunità SOD, anche assieme ad altri attori della società civile, per capire quanto e come il terzo Action Plan e il report a corredo hanno recepito i punti segnalati dalla società civile.

Ci sono tre momenti nel documento:
...
E' utile ricordare che nella fase iniziale del Forum OGP, abbiamo compilato una breve form segnalando del materiale utile da cui partire.  <br/>
Quel materiale e quel lavoro non trova alcuna menzione nel Report finale che correda l'Action Plan.
...
| Questioni aperte       | Risposte           | Note  |
| ------------- |:-------------:| -----:|
| Monitoraggio trasparente dell'attuazione del programma di governo: rilascio in Open Data	|	|
| Commissioni parlamentari trasparenti - campagna #ParlamentoCasadiVetro	|	|
| Patrimoni trasparenti: modulo unico per informazioni strutturate e uguali per tutti; dati aperti; obbligatorietà della dichiarazione completa.	|	|
...
| ------------- | ----- | ----- | ---- | ----| :-------------:|
| Iniziativa: Integrazioni tra scala locale e scala nazionale per la stesura del piano triennale di rilascio degli open data | | Azione 1 <br/> Azione 6 | Stesura coprogettata di un programma nazionale con elenco dataset definiti di interesse.
| Iniziativa: Pilota sul processo di rilascio di open data, da usare come prototipo per la definizione del piano triennale di rilascio | | Azione 1 | Il percorso di definizione dell'Agenda avverrà in consultazione con la società civile.
...
| Tema del commento | Risposta 
| ------------- | :-------------:|
| Apertura datasets | Apertura dataset specifici: le numerose richieste legate alla pubblicazione di dati verranno tenute in considerazione nella fase attuativa dell’azione. |
